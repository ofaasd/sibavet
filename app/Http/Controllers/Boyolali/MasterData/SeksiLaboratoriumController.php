...
class SeksiLaboratoriumController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('boyolali.master-data.seksi-laboratorium.seksi-laboratorium-1', compact('var', 'listSeksiLaboratorium'));
    }
    ...
    public function create()
    {
        ...
        return view('boyolali.master-data.seksi-laboratorium.seksi-laboratorium-2', compact('var'));
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            return redirect('boyolali/master-data/seksi-laboratorium/create')->withInput();
        }

        return redirect('boyolali/master-data/seksi-laboratorium/create');
    }
    ...
    public function show($id)
    {
        ...
        return view('boyolali.master-data.seksi-laboratorium.seksi-laboratorium-2', compact('listSeksiLaboratorium', 'var'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('boyolali/master-data/seksi-laboratorium'.$var['url']['all']);
    }
