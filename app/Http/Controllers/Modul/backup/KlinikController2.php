...
class KlinikController extends Controller
{
    ...
    public function getDetailHewan(Request $request){
        ...
        $det = Klinik::where('klinik.id','=',$var['klinik_id'])->join('ras','klinik.ras_id','=','ras.id')->join('spesies','klinik.spesies_id','=','spesies.id')->select('klinik.*','ras.nama_ras','spesies.nama_spesies')->first();
    ...
    public function detailPeriksa($id){
        ...
        return view('modul.klinik.detailPeriksa', compact('listKlinik','klinikTerapi','dosis','operasi','diagnosa'));
    }
