...
class KlinikController extends Controller
{
	...
	public function edit_pendaftaran(Request $request, $id){
		if(!Auth::user()->hasPermissionTo('Create Klinik')) return view('errors.403');
		$url = $request->route()->getActionMethod();
	...
	public function add_pemeriksaan(Request $request, $id){
		if(!Auth::user()->hasPermissionTo('Create Klinik')) return view('errors.403');
		$url = $request->route()->getActionMethod();
	...
	public function add_pembayaran(Request $request, $id){
		if(!Auth::user()->hasPermissionTo('Create Klinik')) return view('errors.403');
		$url = $request->route()->getActionMethod();
	...
	public function edit_pembayaran(Request $request, $id){
		if(!Auth::user()->hasPermissionTo('Create Klinik')) return view('errors.403');
		$url = $request->route()->getActionMethod();
