...
class JenisPengujianController extends Controller
{
    ...
    {
        if(!Auth::user()->hasPermissionTo('Read Jenis Pengujian')) return view('errors.403');
        ...
        return view('master-data.jenis-pengujian.jenis-pengujian-1', compact('var', 'listJenisPengujian'));
    }
    ...
    public function create()
    {
        ...
        return view('master-data.jenis-pengujian.jenis-pengujian-2', compact('var'));
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            return redirect('master-data/jenis-pengujian/create')->withInput();
        }

        return redirect('master-data/jenis-pengujian/create');
    }
    ...
    public function show($id)
    {
        ...
        return view('master-data.jenis-pengujian.jenis-pengujian-2', compact('listJenisPengujian', 'var'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('master-data/jenis-pengujian'.$var['url']['all']);
    }
