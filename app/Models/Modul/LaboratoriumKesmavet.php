...
class LaboratoriumKesmavet extends Model
{
    protected $table = 'laboratorium_kesmavet';
    protected $fillable = [
        'lab',
    ...
    {
        return $this->belongsToMany('App\Models\MasterData\JenisContoh','lab_contoh_kesmavet','lab_id','contoh_id')
                    ->using('App\Models\MasterData\LabContohKesmavet')
                    ->as('pcontoh')
                    ->withPivot([
                        'id',
                        'jumlah',
    ...
    {
        return $this->belongsToMany('App\Models\MasterData\JenisPengujian','lab_pengujian_kesmavet','lab_id','pengujian_id')
                    ->using('App\Models\MasterData\LabPengujianKesmavet')
                    ->as('pPengujian')
                    ->withPivot([
                        'id',
                        'nol',
