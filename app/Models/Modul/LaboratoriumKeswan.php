...
class LaboratoriumKeswan extends Model
{
    protected $table = 'laboratorium_keswan';
    protected $fillable = [
        'lab',
    ...
    {
        return $this->belongsToMany('App\Models\MasterData\JenisContoh','lab_contoh_keswan','lab_id','contoh_id')
                    ->using('App\Models\MasterData\LabContohKeswan')
                    ->as('pcontoh')
                    ->withPivot([
                        'id',
                        'jumlah',
    ...
    {
        return $this->belongsToMany('App\Models\MasterData\JenisPengujian','lab_pengujian_keswan','lab_id','pengujian_id')
                    ->using('App\Models\MasterData\LabPengujianKeswan')
                    ->as('pPengujian')
                    ->withPivot([
                        'id',
                        'nol',
    ...
    // scope
    // public function scopeWherePengujian($query, $id)
    // {
    //     return $query->belongsToMany('App\Models\MasterData\JenisPengujian','lab_pengujian_keswan','lab_id','pengujian_id')->wherePivot('pengujian_id',$id);
    // }
    public function manajerTeknis()
    {
        return $this->belongsTo('App\Models\MasterData\Pegawai','manajer_teknis');
    }

    public function pengujiDitunjuk()
    {
        return $this->belongsTo('App\Models\MasterData\Pegawai','penguji_ditunjuk');
    }
}