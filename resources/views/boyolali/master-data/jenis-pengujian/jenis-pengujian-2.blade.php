                ...
                <div class="box box-default">
                    ...
                    <div class="box-body">
                        ...
                        <ul class="nav nav-tabs">
                            <li class="nav-item"><a href="{{ url('boyolali/master-data/jenis-pengujian') }}" class="nav-link"><span class="hidden-sm-up"><b>Lihat Data</b></span> <span class="hidden-xs-down"><b>Lihat Data</b></span></a></li>
                            <li class="nav-item"><a href="{{ url('boyolali/master-data/jenis-pengujian/create') }}" class="nav-link active"><span class="hidden-sm-up"><b>Tambah Data</b></span> <span class="hidden-xs-down"><B>Tambah Data</b></span></a></li>
                        </ul>
                        <!-- Tab panes -->
                        <div class="tab-content tabcontent-border">
                            <div class="tab-pane active">
                                <div class="pad">
                                    @if($var['method']=='edit')
                                        {!! Form::model($listJenisPengujian, ['method'=>'PATCH', 'url'=> '/boyolali/master-data/jenis-pengujian/'.$listJenisPengujian->id.$var['url']['all'], 'id'=>'form-jenis-pengujian']) !!}
                                    @elseif($var['method']=='create')
                                        {!! Form::open(['id'=>'form-jenis-pengujian', 'method'=>'POST', 'url'=>'/boyolali/master-data/jenis-pengujian']) !!}
                                    @else
