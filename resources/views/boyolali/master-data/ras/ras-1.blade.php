                ...
                <div class="box box-default">
                    ...
                    <div class="box-body">
                        ...
                        <ul class="nav nav-tabs">
                            <li class="nav-item"><a href="{{ url('master-data/ras') }}" class="nav-link active"><span class="hidden-sm-up"><b>Lihat Data</b></span> <span class="hidden-xs-down"><b>Lihat Data</b></span></a></li>
                            @can('Create Ras')
                                <li class="nav-item"><a href="{{ url('master-data/ras/create') }}" class="nav-link"><span class="hidden-sm-up"><b>Tambah Data</b></span> <span class="hidden-xs-down"><B>Tambah Data</b></span></a></li>
                            @endcan
                        </ul>
                        <!-- Tab panes -->
                            ...
                            <div class="tab-pane active">
                                <div class="pad">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            @can('Create Ras')
                                                <a href="{{ url('master-data/ras/create') }}" class="btn btn-primary"><b>Tambah Data</b></a>
                                            @endcan
                                        </div>
                                        <div class="col-lg-6">
                                        ...
                                        <table class="table table-hover">
                                            <thead>
                                                <tr class="bg-dark">
                                                    ...
                                                    <th style="text-align:center;">Nama Ras</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                            @php
