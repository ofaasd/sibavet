                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <select name="jenis" id="jenis" class="form-control">
                                                    <option value="utama">Data Utama</option>
                                                    <option value="penyakit">Peta Penyakit</option>
                                                    <option value="Vaksinasi">Vaksinasi</option>
                                                    <option value="Operasi">Operasi</option>
                                                    <option value="Doperasi">Obat dan Bahan Operasi</option>
                                                    <option value="pad">Laporan PAD</option>
                                                    <option value="bulanan">Laporan Bulanan Obat</option>
                                                    <option value="utama2">Laporan Kegiatan</option>
                                                </select>
                                            </div>
                                        </div>
										<div id="form_tahun">
