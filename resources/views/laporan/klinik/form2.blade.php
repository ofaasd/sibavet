                                ...
                                <div class="pad">
                                    {!! Form::open(['id'=>'form-cetak-klinik', 'method'=>'POST', 'url'=>'/laporan/lap-klinik']) !!}
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                {!! Form::select('jenis', ['utama'=>'Data Utama','penyakit'=>'Peta Penyakit','Vaksinasi'=>'Vaksinasi','Operasi'=>'Operasi','Doperasi'=>'Obat dan Bahan Operasi','pad'=>'Laporan PAD','bulanan'=>'Laporan Bulanan Obat','utama2'=>'Laporan Kegiatan'],null, ['class'=>'form-control']) !!}
                                            </div>
                                        </div>
										<div id="form_tahun">
											<div class="form-group row">
