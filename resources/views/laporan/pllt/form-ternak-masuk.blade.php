...
@section('content')
    ...
    <section class="content-header">
        <h1>
            Laporan Ternak Masuk
        </h1>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Beranda</a></li>
            <li class="breadcrumb-item"><a href="#">Laporan</a></li>
            <li class="breadcrumb-item active">Laporan Ternak Masuk</li>
        </ol>
    </section>
...
@section('javascript')
    <script type="text/javascript">
        $(document).ready(function() {
            $("#form-cetak-ternak-masuk").validate({
                rules: {
        ...
        $('#btnPrev').click(function(e){
                ...
                $("#prev").load('{!! url('/laporan/lap-ternak-masuk-prev') !!}?dari_tanggal='+dari_tanggal+'&sampai_tanggal='+sampai_tanggal+'&sub_satuan_kerja_id='+sat+'&format='+format+'&jenis='+jenis);
            });
    </script>
@endsection
