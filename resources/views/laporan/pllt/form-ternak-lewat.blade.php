...
@section('content')
    ...
    <section class="content-header">
        <h1>
            Laporan Ternak Lewat
        </h1>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Beranda</a></li>
            <li class="breadcrumb-item"><a href="#">Laporan</a></li>
            <li class="breadcrumb-item active">Laporan Ternak Lewat</li>
        </ol>
    </section>
                    ...
                    <div class="box-body">
                        ...
                        <div class="tab-content tabcontent-border">
                            <div class="tab-pane active">
                                <div class="pad">
                                    {!! Form::open(['id'=>'form-cetak-ternak-lewat', 'method'=>'POST', 'url'=>'/laporan/lap-ternak-lewat', 'target'=>'_blank']) !!}
...
@section('javascript')
    <script type="text/javascript">
        $(document).ready(function() {
            $("#form-cetak-ternak-lewat").validate({
                rules: {
        ...
        $('#btnPrev').click(function(e){
                ...
                $("#prev").load('{!! url('/laporan/lap-ternak-lewat-prev') !!}?dari_tanggal='+dari_tanggal+'&sampai_tanggal='+sampai_tanggal+'&sub_satuan_kerja_id='+sat+'&format='+format+'&jenis='+jenis);
            });
    </script>
@endsection
