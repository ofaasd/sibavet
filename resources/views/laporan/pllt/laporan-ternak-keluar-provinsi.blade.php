<html>
	...
	<body>
        <center><h3>LAPORAN DATA TERNAK KELUAR PROVINSI JAWA TENGAH</h3></center>
        ...
        <table class="table-border">
            <thead>
                <tr>
                    ...
                    <th rowspan="4" style="text-align:center; font-size:12px; background-color: #c1c1c1;">DAERAH TUJUAN</th>
            ...
            <tbody>
                ...
                @foreach($provinsiTujuan as $item)
                    @php
                        $no++;
                        $kolomProvinsiTujuan = $helper->kolomProvinsiTujuan($item->provinsi_tujuan_id);
                    @endphp
                        <tr>
                            <td style="text-align:center; vertical-align:middle;">{{ $no }}</td>
                            <td style="text-align:center; vertical-align:middle;">{{ $kolomProvinsiTujuan['provinsiTujuan']->name }}</td>

                            @php
                                $jumlahJantan = $helper->jumlahPopulasiProvinsiTujuan($var['dari_tanggal'], $var['sampai_tanggal'], $var['subSatuanKerjaId'], $var['jenisForm'],
                                                            $item->provinsi_tujuan_id, 'SAPI BIBIT', 'P.B/BX', 'Jantan');
                                $jumlahBetina = $helper->jumlahPopulasiProvinsiTujuan($var['dari_tanggal'], $var['sampai_tanggal'], $var['subSatuanKerjaId'], $var['jenisForm'],
                                                            $item->provinsi_tujuan_id, 'SAPI BIBIT', 'P.B/BX', 'Betina');
                            ...
                            @php
                                $jumlahJantan = $helper->jumlahPopulasiProvinsiTujuan($var['dari_tanggal'], $var['sampai_tanggal'], $var['subSatuanKerjaId'], $var['jenisForm'],
                                                            $item->provinsi_tujuan_id, 'SAPI BIBIT', 'P.L', 'Jantan');
                                $jumlahBetina = $helper->jumlahPopulasiProvinsiTujuan($var['dari_tanggal'], $var['sampai_tanggal'], $var['subSatuanKerjaId'], $var['jenisForm'],
                                                            $item->provinsi_tujuan_id, 'SAPI BIBIT', 'P.L', 'Betina');
                            ...
                            @php
                                $jumlahJantan = $helper->jumlahPopulasiProvinsiTujuan($var['dari_tanggal'], $var['sampai_tanggal'], $var['subSatuanKerjaId'], $var['jenisForm'],
                                                            $item->provinsi_tujuan_id, 'SAPI BIBIT', 'P.S', 'Jantan');
                                $jumlahBetina = $helper->jumlahPopulasiProvinsiTujuan($var['dari_tanggal'], $var['sampai_tanggal'], $var['subSatuanKerjaId'], $var['jenisForm'],
                                                            $item->provinsi_tujuan_id, 'SAPI BIBIT', 'P.S', 'Betina');
                            ...
                            @php
                                $jumlahJantan = $helper->jumlahPopulasiProvinsiTujuan($var['dari_tanggal'], $var['sampai_tanggal'], $var['subSatuanKerjaId'], $var['jenisForm'],
                                                            $item->provinsi_tujuan_id, 'SAPI BIBIT', 'P.O', 'Jantan');
                                $jumlahBetina = $helper->jumlahPopulasiProvinsiTujuan($var['dari_tanggal'], $var['sampai_tanggal'], $var['subSatuanKerjaId'], $var['jenisForm'],
                                                            $item->provinsi_tujuan_id, 'SAPI BIBIT', 'P.O', 'Betina');
                            ...
                            @php
                                $jumlahJantan = $helper->jumlahPopulasiProvinsiTujuan($var['dari_tanggal'], $var['sampai_tanggal'], $var['subSatuanKerjaId'], $var['jenisForm'],
                                                            $item->provinsi_tujuan_id, 'SAPI BIBIT', 'P.FH', 'Jantan');
                                $jumlahBetina = $helper->jumlahPopulasiProvinsiTujuan($var['dari_tanggal'], $var['sampai_tanggal'], $var['subSatuanKerjaId'], $var['jenisForm'],
                                                            $item->provinsi_tujuan_id, 'SAPI BIBIT', 'P.FH', 'Betina');
							...
							@php
								$jumlahJantan = $helper->jumlahPopulasiProvinsiTujuan($var['dari_tanggal'], $var['sampai_tanggal'], $var['subSatuanKerjaId'], $var['jenisForm'],
															$item->provinsi_tujuan_id, 'SAPI BIBIT', 'Madura', 'Jantan');
								$jumlahBetina = $helper->jumlahPopulasiProvinsiTujuan($var['dari_tanggal'], $var['sampai_tanggal'], $var['subSatuanKerjaId'], $var['jenisForm'],
															$item->provinsi_tujuan_id, 'SAPI BIBIT', 'Madura', 'Betina');
                            ...
                            @php
                                $jumlahJantan = $helper->jumlahPopulasiProvinsiTujuan($var['dari_tanggal'], $var['sampai_tanggal'], $var['subSatuanKerjaId'], $var['jenisForm'],
                                                            $item->provinsi_tujuan_id, 'SAPI POTONG', 'P.B/BX', 'Jantan');
                                $jumlahBetina = $helper->jumlahPopulasiProvinsiTujuan($var['dari_tanggal'], $var['sampai_tanggal'], $var['subSatuanKerjaId'], $var['jenisForm'],
                                                            $item->provinsi_tujuan_id, 'SAPI POTONG', 'P.B/BX', 'Betina');
                            ...
                            @php
                                $jumlahJantan = $helper->jumlahPopulasiProvinsiTujuan($var['dari_tanggal'], $var['sampai_tanggal'], $var['subSatuanKerjaId'], $var['jenisForm'],
                                                            $item->provinsi_tujuan_id, 'SAPI POTONG', 'P.L', 'Jantan');
                                $jumlahBetina = $helper->jumlahPopulasiProvinsiTujuan($var['dari_tanggal'], $var['sampai_tanggal'], $var['subSatuanKerjaId'], $var['jenisForm'],
                                                            $item->provinsi_tujuan_id, 'SAPI POTONG', 'P.L', 'Betina');
                            ...
                            @php
                                $jumlahJantan = $helper->jumlahPopulasiProvinsiTujuan($var['dari_tanggal'], $var['sampai_tanggal'], $var['subSatuanKerjaId'], $var['jenisForm'],
                                                            $item->provinsi_tujuan_id, 'SAPI POTONG', 'P.S', 'Jantan');
                                $jumlahBetina = $helper->jumlahPopulasiProvinsiTujuan($var['dari_tanggal'], $var['sampai_tanggal'], $var['subSatuanKerjaId'], $var['jenisForm'],
                                                            $item->provinsi_tujuan_id, 'SAPI POTONG', 'P.S', 'Betina');
                            ...
                            @php
                                $jumlahJantan = $helper->jumlahPopulasiProvinsiTujuan($var['dari_tanggal'], $var['sampai_tanggal'], $var['subSatuanKerjaId'], $var['jenisForm'],
                                                            $item->provinsi_tujuan_id, 'SAPI POTONG', 'P.O', 'Jantan');
                                $jumlahBetina = $helper->jumlahPopulasiProvinsiTujuan($var['dari_tanggal'], $var['sampai_tanggal'], $var['subSatuanKerjaId'], $var['jenisForm'],
                                                            $item->provinsi_tujuan_id, 'SAPI POTONG', 'P.O', 'Betina');
                            ...
                            @php
                                $jumlahJantan = $helper->jumlahPopulasiProvinsiTujuan($var['dari_tanggal'], $var['sampai_tanggal'], $var['subSatuanKerjaId'], $var['jenisForm'],
                                                            $item->provinsi_tujuan_id, 'SAPI POTONG', 'P.FH', 'Jantan');
                                $jumlahBetina = $helper->jumlahPopulasiProvinsiTujuan($var['dari_tanggal'], $var['sampai_tanggal'], $var['subSatuanKerjaId'], $var['jenisForm'],
                                                            $item->provinsi_tujuan_id, 'SAPI POTONG', 'P.FH', 'Betina');
                            ...
                            @php
                                $jumlahJantan = $helper->jumlahPopulasiProvinsiTujuan($var['dari_tanggal'], $var['sampai_tanggal'], $var['subSatuanKerjaId'], $var['jenisForm'],
                                                            $item->provinsi_tujuan_id, 'SAPI POTONG', 'Bali', 'Jantan');
                                $jumlahBetina = $helper->jumlahPopulasiProvinsiTujuan($var['dari_tanggal'], $var['sampai_tanggal'], $var['subSatuanKerjaId'], $var['jenisForm'],
                                                            $item->provinsi_tujuan_id, 'SAPI POTONG', 'Bali', 'Betina');
							...
							@php
								$jumlahJantan = $helper->jumlahPopulasiProvinsiTujuan($var['dari_tanggal'], $var['sampai_tanggal'], $var['subSatuanKerjaId'], $var['jenisForm'],
															$item->provinsi_tujuan_id, 'SAPI POTONG', 'Madura', 'Jantan');
								$jumlahBetina = $helper->jumlahPopulasiProvinsiTujuan($var['dari_tanggal'], $var['sampai_tanggal'], $var['subSatuanKerjaId'], $var['jenisForm'],
															$item->provinsi_tujuan_id, 'SAPI POTONG', 'Madura', 'Betina');
                            ...
                            @php
                                $jumlahJantan = $helper->jumlahPopulasiProvinsiTujuan($var['dari_tanggal'], $var['sampai_tanggal'], $var['subSatuanKerjaId'], $var['jenisForm'],
                                                            $item->provinsi_tujuan_id, 'KERBAU', '', 'Jantan');
                                $jumlahBetina = $helper->jumlahPopulasiProvinsiTujuan($var['dari_tanggal'], $var['sampai_tanggal'], $var['subSatuanKerjaId'], $var['jenisForm'],
                                                            $item->provinsi_tujuan_id, 'KERBAU', '', 'Betina');
                            ...
                            @php
                                $jumlahJantan = $helper->jumlahPopulasiProvinsiTujuan($var['dari_tanggal'], $var['sampai_tanggal'], $var['subSatuanKerjaId'], $var['jenisForm'],
                                                            $item->provinsi_tujuan_id, 'KUDA', '', 'Jantan');
                                $jumlahBetina = $helper->jumlahPopulasiProvinsiTujuan($var['dari_tanggal'], $var['sampai_tanggal'], $var['subSatuanKerjaId'], $var['jenisForm'],
                                                            $item->provinsi_tujuan_id, 'KUDA', '', 'Betina');
                            ...
                            @php
                                $jumlah = $helper->jumlahPopulasiProvinsiTujuan($var['dari_tanggal'], $var['sampai_tanggal'], $var['subSatuanKerjaId'], $var['jenisForm'],
                                                            $item->provinsi_tujuan_id, 'BABI', '', 'JanBet');
                            ...
                            @php
                                $jumlahJantan = $helper->jumlahPopulasiProvinsiTujuan($var['dari_tanggal'], $var['sampai_tanggal'], $var['subSatuanKerjaId'], $var['jenisForm'],
                                                            $item->provinsi_tujuan_id, 'KAMBING', '', 'Jantan');
                                $jumlahBetina = $helper->jumlahPopulasiProvinsiTujuan($var['dari_tanggal'], $var['sampai_tanggal'], $var['subSatuanKerjaId'], $var['jenisForm'],
                                                            $item->provinsi_tujuan_id, 'KAMBING', '', 'Betina');
                            ...
                            @php
                                $jumlahJantan = $helper->jumlahPopulasiProvinsiTujuan($var['dari_tanggal'], $var['sampai_tanggal'], $var['subSatuanKerjaId'], $var['jenisForm'],
                                                            $item->provinsi_tujuan_id, 'DOMBA', '', 'Jantan');
                                $jumlahBetina = $helper->jumlahPopulasiProvinsiTujuan($var['dari_tanggal'], $var['sampai_tanggal'], $var['subSatuanKerjaId'], $var['jenisForm'],
                                                            $item->provinsi_tujuan_id, 'DOMBA', '', 'Betina');
                            ...
                            @php
                                $jumlah = $helper->jumlahPopulasiProvinsiTujuan($var['dari_tanggal'], $var['sampai_tanggal'], $var['subSatuanKerjaId'], $var['jenisForm'],
                                                            $item->provinsi_tujuan_id, 'UNGGAS', '', 'JanBet');
                            ...
                            @php
                                $jumlah = $helper->jumlahPopulasiProvinsiTujuan($var['dari_tanggal'], $var['sampai_tanggal'], $var['subSatuanKerjaId'], $var['jenisForm'],
                                                            $item->provinsi_tujuan_id, 'ITIK', '', 'JanBet');
                            ...
                            @php
                                $jumlah = $helper->jumlahPopulasiProvinsiTujuan($var['dari_tanggal'], $var['sampai_tanggal'], $var['subSatuanKerjaId'], $var['jenisForm'],
                                                            $item->provinsi_tujuan_id, 'DOC', '', 'JanBet');
                                @$jumArray['doc'] += $jumlah;
                            @endphp
                            <td style="text-align:center; vertical-align:middle;">{{ $jumlah }}</td>
                            ...
                            @php
                                $jumlah = $helper->jumlahPopulasiProvinsiTujuan($var['dari_tanggal'], $var['sampai_tanggal'], $var['subSatuanKerjaId'], $var['jenisForm'],
                                                            $item->provinsi_tujuan_id, 'TELUR', '', 'JanBet');
                                @$jumArray['telur'] += $jumlah;
                            @endphp
                            <td style="text-align:center; vertical-align:middle;">{{ $jumlah }}</td>

                            @php
                                $jumlah = $helper->jumlahDokumenProvinsiTujuan($var['dari_tanggal'], $var['sampai_tanggal'], $var['subSatuanKerjaId'], $var['jenisForm'],
                                                            $item->provinsi_tujuan_id, 'SPT');
                                @$jumArray['spt'] += $jumlah;
                            @endphp
                            <td style="text-align:center; vertical-align:middle;">{{ $jumlah }}</td>
                            ...
                            @php
                                $jumlah = $helper->jumlahDokumenProvinsiTujuan($var['dari_tanggal'], $var['sampai_tanggal'], $var['subSatuanKerjaId'], $var['jenisForm'],
                                                            $item->provinsi_tujuan_id, 'TANPA SURAT');
