                        ...
                        <div class="tab-content tabcontent-border">
                            <div class="tab-pane active">
                                <div class="pad">
                                    ...
                                    @elseif($var['method'] == 'add')
                                    {!! Form::model($listKlinik, ['method'=>'POST', 'url'=> '/klinik/tambahTerapi/'.$listKlinik->id.$var['url']['all'], 'id'=>'form-klinik']) !!}
                                    @else
                                    ...
                                    @endif
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                {!! Form::text('nama_sub_satuan_kerja', ($var['method']=='edit'||$var['method']=='show'||$var['method']=='add'?@$listKlinik->inputBy->subSatuanKerja->sub_satuan_kerja:$var['namaKlinik']), ['class'=>'form-control', 'id'=>'nama_sub_satuan_kerja', 'placeholder'=>'Inputkan Nama Klinik', 'readonly']) !!}
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                {!! Form::text('no_pasien', null, ['class'=>'form-control', 'placeholder'=>'Inputkan No. RM']) !!}
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                {!! Form::text('alamat_pemilik', ($var['method']=='edit'||$var['method']=='show'||$var['method']=='add'?@$listKlinik->pemilik->alamat:null), ['class'=>'form-control', 'placeholder'=>'Inputkan Alamat Pemilik', 'readonly']) !!}
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            {!! Form::label('telepon_pemilik', 'Telepon Pemilik', ['class' => 'col-sm-2 col-form-label']) !!}
                                            <div class="col-sm-10">
                                                {!! Form::text('telepon_pemilik',  ($var['method']=='edit'||$var['method']=='show'||$var['method']=='add'?@$listKlinik->pemilik->telepon:null), ['class'=>'form-control', 'placeholder'=>'Inputkan Telepon Pemilik', 'readonly']) !!}
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div id="areaRas">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    {!! Form::select('ras_id', $var['ras'], null, ['class'=>'form-control select2', 'placeholder'=>'Pilih Ras', 'style'=>'width: 100%;']) !!}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                {!! Form::text('ciri_ciri', null, ['class'=>'form-control', 'placeholder'=>'Inputkan Ciri - Ciri']) !!}
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            {!! Form::label('no_periksa', 'Nomor Periksa', ['class' => 'col-sm-2 col-form-label']) !!}
                                            <div class="col-sm-4">
                                                {!! Form::text('no_periksa', ($var['method']=='create'||$var['method']=='add'?$var['noPeriksa']:null), ['class'=>'form-control', 'placeholder'=>'Inputkan Nomor Periksa', 'readonly']) !!}
                                            </div>
                                            {!! Form::label('tanggal_periksa', 'Tanggal Periksa', ['class' => 'col-sm-2 col-form-label']) !!}
                                            <div class="col-sm-4">
                                                {!! Form::text('tanggal_periksa', '', ['class'=>'form-control', 'placeholder'=>'Inputkan Tanggal Periksa']) !!}
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            {!! Form::label('signalement', 'Signalement', ['class' => 'col-sm-2 col-form-label']) !!}
                                            <div class="col-sm-10">
                                                {!! Form::text('signalement', '', ['class'=>'form-control', 'placeholder'=>'Inputkan Signalement']) !!}
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            {!! Form::label('anamnesia', 'Anamnesa', ['class' => 'col-sm-2 col-form-label']) !!}
                                            <div class="col-sm-10">
                                                {!! Form::text('anamnesia', '', ['class'=>'form-control', 'placeholder'=>'Inputkan Anamnesa']) !!}
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            {!! Form::label('diagnosa', 'Diagnosa', ['class' => 'col-sm-2 col-form-label']) !!}
                                            <div class="col-sm-10">
                                                {!! Form::text('diagnosa', '', ['class'=>'form-control', 'placeholder'=>'Inputkan Diagnosa']) !!}
                                            </div>
                                        </div>
                                        <div class="form-group row">
    ...
    <script>
        ...
        function pemilik(pemilikId = '') {
            ...
            $.ajax({
                ...
                $("#alamat_pemilik").val(data.alamat);
                $("#telepon_pemilik").val(data.telepon);
            });
        }
        ...
        $(document).ready(function() {
            ...
            $('#buttonTambahTerapiDosis').click(function(e){
                ...
                var data = {
                    ...
                    penanganan: ($("#tindakan").val()!=""?$("#tindakan").val():"")
                };
