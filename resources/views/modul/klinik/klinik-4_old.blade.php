    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#buttonTambahTerapiDosis').click(function(e){
				...
				var tindakan_text = $("#id_sampel option:selected").text();
				var terapi_text = $("#pengujian_id option:selected").text();
				var dosis_text = $("#hasil_pengujian option:selected").text();
				t.row.add([
					'<input type="hidden" name="sampel[]" value="'+tindakan+'">'+tindakan_text,
					'<input type="hidden" name="pengujian[]" value="'+terapi_id+'">'+terapi_text,
					'<input type="hidden" name="hasil_pengujian[]" value="'+dosis+'">'+dosis_text,
