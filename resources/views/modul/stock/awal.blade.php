                        ...
                        <div class="tab-content tabcontent-border">
                            <div class="tab-pane active">
                                <div class="pad">
									...
									<a href="{{url('stock/tambah_stock_awal')}}" class="btn btn-primary">Tambah Stok Awal</a>
                                    <br> 
                                    <br />
                                            ...
                                            @foreach($p_stock as $item)
                                                ...
                                                <tr>
                                                    <td style="text-align:center">
														...
														<div class="btn-group">
                                                            {!! Form::open(['method'=>'post', 'url'=>'/stock/hapus_stock_awal', 'class'=> 'delete_form']) !!}
                                                            ...
                                                            <div class="btn-group btn-group-xs" role="group" aria-label="Basic example">
																...
																<a href="{{url('stock/edit_stock_awal/' . $item->id)}}" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i></a>
