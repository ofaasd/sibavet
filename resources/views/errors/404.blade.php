			...
			<div class="col-lg-8 col-11">
			  <div class="error-page bg-white rounded">
				<div class="error-content">
					<div class="row h-p100 align-items-center bg-bubbles-dark bg-warning">
						<div class="col-lg-6 col-md-12 bg-white text-dark">
							<div class="p-30">
								...
								<p>Halaman yang anda cari tidak ditemukan. Cek url sekali lagi. </p>
								<div class="mb-15">
						...
						<div class="col-lg-6 col-md-12">
						 	<div class="error-content-inner text-center p-15">
							  ...
							  <h2>Halaman tidak ditemukan !</h2>
								 <h4 class="mb-15">Halaman yang anda cari tidak ditemukan. Cek url sekali lagi.</h4>
							</div>
						</div>
					</div>
				</div>
