                    ...
                    <form action="{{ route('login') }}" method="POST" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <div class="row gy-4">
                            ...
                            <div class="col-md-12 text-center">
                                ...
                                <div class="sent-message d-none">Berhasil masuk.</div>
    ...
    <div class="container footer-top">
      <div class="row gy-4">
        <div class="col-lg-5 col-md-12 footer-about">
          ...
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Expedita molestiae, aspernatur facilis enim rerum fuga quod eos, repellat aut nesciunt dolore alias sit quos facere placeat repellendus repudiandae dicta odit!</p>
