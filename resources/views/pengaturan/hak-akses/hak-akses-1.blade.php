                ...
                <div class="box box-default">
                    ...
                    <div class="box-body">
                        ...
                        <ul class="nav nav-tabs">
                            <li class="nav-item"><a href="{{ url('pengaturan/hak-akses') }}" class="nav-link active"><span class="hidden-sm-up"><b>Lihat Data</b></span> <span class="hidden-xs-down"><b>Lihat Data</b></span></a></li>
                            @can('Create Hak Akses')
                                <li class="nav-item"><a href="{{ url('pengaturan/hak-akses/create') }}" class="nav-link"><span class="hidden-sm-up"><b>Tambah Data</b></span> <span class="hidden-xs-down"><B>Tambah Data</b></span></a></li>
                            @endcan
                        </ul>
                        <!-- Tab panes -->
                            ...
                            <div class="tab-pane active">
                                <div class="pad">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            @can('Create Hak Akses')
                                                <a href="{{ url('pengaturan/hak-akses/create') }}" class="btn btn-primary"><b>Tambah Data</b></a>
                                            @endcan
                                        </div>
                                        <div class="col-lg-6">
