    ...
    <body>
        ...
        <table class="table-no-border" cellpadding="3">
            <tr>
                ...
                <td width="3%"><b>:</b></td>
                <td colspan="2">{{ @$pakan->subSatuanKerja->sub_satuan_kerja }}</td>
            </tr>
            <tr>
                <td width="30%"><b>NAMA PENGIRIM</b></td>
                <td width="3%"><b>:</b></td>
                <td colspan="2">{{ @$pakan->customer->nama_pelanggan }}</td>
            </tr>
            <tr>
                <td width="30%"><b>ALAMAT</b></td>
                <td width="3%"><b>:</b></td>
                <td colspan="2">{{ @$pakan->customer->alamat }}</td>
            </tr>
            @php
                $pakangrup = $pakan->pakanTr->groupBy('urut');
            @endphp
            @foreach($pakangrup as $key=>$pakang)
            <tr style="border:solid 1px;">
                <td width="30%">{!! $key==0?"<b>CONTOH</b>":"" !!}</td>
                <td width="3%">{!! $key==0?"<b>:</b>":"" !!}</td>
                <td width="30%">{{ @$pakang->first()->contoh->nama_sampel }}</td>
        ...
        <table class="table-no-border">
            <tr>
                <td  style="vertical-align:middle;"><b>BAHWA KIRIMAN CONTOH SDR. TELAH KAMI TERIMA : {!! $pakan->kriteria_contoh=="MS"?"MEMENUHI SYARAT":"TIDAK MEMENUHI SYARAT" !!}</b></td>
            </tr>
        </table>
        ...
        <table class="table-no-border" style="padding-top:-20px;">
            ...
            <tr>
                ...
                <td width="3%"><b>:</b></td>
                @if($pakan->bahan == 'Mampu')
                    <td colspan="3"><b>1). Mampu* &nbsp;&nbsp;&nbsp;&nbsp; <s>2. Tidak Mampu*</s></b></td>
                @elseif($pakan->bahan == 'Tidak Mampu')
                <td colspan="3"><b><s>1). Mampu*</s> &nbsp;&nbsp;&nbsp;&nbsp; 2. Tidak Mampu*</b></td>
                @endif
            </tr>
            <tr>
                ...
                <td width="3%"><b>:</b></td>
                @if($pakan->personil == 'Mampu')
                    <td colspan="3"><b>1). Mampu* &nbsp;&nbsp;&nbsp;&nbsp; <s>2. Tidak Mampu*</s></b></td>
                @elseif($pakan->personil == 'Tidak Mampu')
                <td colspan="3"><b><s>1). Mampu*</s> &nbsp;&nbsp;&nbsp;&nbsp; 2. Tidak Mampu*</b></td>
                @endif
            </tr>
            <tr>
        ...
        <table class="table-no-border">
            <tr>
                <td colspan="5"></td>
                <td colspan="1" style="text-align:center; padding-right:30px;">Semarang, {!! tanggal(@$pakan->tanggal_penerimaan) !!}</td>
            </tr>
            <tr>
