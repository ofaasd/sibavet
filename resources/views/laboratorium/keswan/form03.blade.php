                ...
                <div class="box-body wizard-content">
                    <section>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                {!! viewSelectSeksiLab(1,'seksi_laboratorium_id',$keswan->seksi_laboratorium_id) !!}
                            </div>
                        </div>
                        <div class="form-group row">
                            {!! Form::label('manajer_teknis', 'Manajer Teknis :', ['class' => 'col-sm-2 col-form-label']) !!}
                            <div class="col-sm-10">
                                {!! viewSelectPegawai(1,'manajer_teknis', $keswan->manajer_teknis) !!}
                            </div>
                        </div>
                        <div class="form-group row">
                            {!! Form::label('catatan_03', 'Catatan/Saran :', ['class' => 'col-sm-2 col-form-label']) !!}
                            <div class="col-sm-10">
                                {!! Form::textarea('catatan_03', $keswan->catatan_03, array('class'=> 'form-control', 'rows' => '2','placeholder'=>'Catatan/Saran')) !!}
                            </div>
                        </div>
                    </section>
                </div>
