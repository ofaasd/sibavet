    ...
    <body>
        ...
        <table class="table-no-border" cellpadding="3">
            ...
            <tr>
                ...
                <td width="3%"><b>:</b></td>
                <td colspan="3" style="">{{ @$keswan->no_epid }}</td>
            </tr>
            <tr>
                <td width="30%"><b>LABORATORIUM PENGUJI</b></td>
                <td width="3%"><b>:</b></td>
                <td colspan="3" style="">{{ @$keswan->seksiLaboratorium->seksi_laboratorium }}</td>
            </tr>
            <tr>
                <td width="30%"><b>PENGUJI YANG DITUNJUK</b></td>
                <td width="3%"><b>:</b></td>
                <td colspan="3" style="">{{ $keswan->penguji_ditunjuk }}</td>
            </tr>
            <tr>
                <td width="30%"><b>TANGGAL DITERIMA CONTOH</b></td>
                <td width="3%"><b>:</b></td>
                <td colspan="3" style="">{{ $keswan->tanggal_penerimaan }}</td>
            </tr>
        </table>
             ...
             @foreach($keswan->labPengujian as $key=>$uji)
                @if($uji->tipe_hasil==1)
                    @if($a<1)
                        ...
                        @endphp
                        <tr>
                            <th style="text-align:center; font-size:14px;">Jenis Pengujian</th>
                            <th style="text-align:center; font-size:14px;">JUMLAH</th>
                            <th style="text-align:center; font-size:14px;">Titer 0</th>
                            <th style="text-align:center; font-size:14px;">Titer Rendah</th>
                            <th style="text-align:center; font-size:14px;">Titer Tinggi</th>
                        </tr>
                    @endif
                <tr>
                    <td style="padding:5px;vertical-align:middle;">{!! $uji->jenis_pengujian !!}</td>
                    <td style="padding:5px;vertical-align:middle; text-align: center;">{!! $jumlah_contoh !!}</td>
                    <td style="padding:5px;vertical-align:middle; text-align: center;">{!! @$uji->pPengujian->nol !!}</td>
                    <td style="padding:5px;vertical-align:middle; text-align: center;">{!! @$uji->pPengujian->rendah !!}</td>
                    <td style="padding:5px;vertical-align:middle; text-align: center;">{!! @$uji->pPengujian->tinggi !!}</td>>
                </tr>
                @endif
            @endforeach
        </table>
                ...
                @if($uji->tipe_hasil==0)
                    @if($b<1)
                        ...
                        <tr>
                            <th style="text-align:center; font-size:14px;">Jenis Pengujian</th>
                            <th style="text-align:center; font-size:14px;">JUMLAH</th>
                            <th style="text-align:center; font-size:14px;">Negatif</th>
                            <th style="text-align:center; font-size:14px;">Positif</th>
                        </tr>
                    @endif
                <tr>
                    <td style="padding:5px;vertical-align:middle;">{!! $uji->jenis_pengujian !!}</td>
                    ...
                    <td style="padding:5px;vertical-align:middle; text-align: center;">{!! @$uji->pPengujian->negatif !!}</td>
                    <td style="padding:5px;vertical-align:middle; text-align: center;">{!! @$uji->pPengujian->positif !!}</td>
                </tr>
                @endif
            @endforeach
        </table>
        <table>
            <tr>
                ...
                <td width="3%"><b>:</b></td>
                <td colspan="3">{{ $keswan->catatan_hasil }}</td>
            </tr>
        </table>
        ...
        <table class="table-no-border">
            <tr>
                <td colspan="5"></td>
                <td colspan="1" style="text-align:center; padding-right:30px;">Semarang, {!! tanggal(@$keswan->time_03) !!}</td>
            </tr>
            <tr>
                ...
                <td style="">
                    ...
                    <br /><br /><br /><br />
                    <center>{{  @$keswan->manajer_teknis }}</center>
                </td>
            </tr>
            <tr>
