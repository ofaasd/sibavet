                    ...
                    <div class="box-body">
                        ...
                        <div class="tab-content tabcontent-border">
                            <div class="tab-pane active">
                                <div class="pad">
                                    @if($var['method']=='edit')
                                        <form id="form-spesies" method="POST" action="/master-data/spesies/{{ $listSpesies->id }}{{ $var['url']['all'] }}">
                                            @csrf
                                            @method('PATCH')
                                    @elseif($var['method']=='create')
                                        <form id="form-spesies" method="POST" action="/master-data/spesies">
                                            @csrf
                                    @else
                                    ...
                                    @endif
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="kode" id="kode" class="form-control" placeholder="Inputkan Kode" value="{{ old('kode', $listSpesies->kode ?? '') }}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="nama_spesies" class="col-sm-2 col-form-label">Nama Spesies</label>
                                            <div class="col-sm-10">
                                                <input type="text" name="nama_spesies" id="nama_spesies" class="form-control" placeholder="Inputkan Nama Spesies" value="{{ old('nama_spesies', $listSpesies->nama_spesies ?? '') }}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
