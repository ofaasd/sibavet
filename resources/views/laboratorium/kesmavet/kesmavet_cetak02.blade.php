    ...
    <body><table class="header">
        ...
        <table class="table-no-border" cellpadding="3">
            <tr>
                ...
                <td width="3%"><b>:</b></td>
                <td colspan="3">{{ $kesmavet->tanggal_penerimaan }}</td>
            </tr>
            <tr>
                <td width="30%"><b>ASAL CONTOH</b></td>
                <td width="3%"><b>:</b></td>
                <td colspan="3">{{ $kesmavet->kotaKabupaten->name }}</td>
            </tr>
            @php
            $pengujian = "";
            ...
            <tr>
                ...
                <td width="3%"><b>:</b></td>
                <td colspan="3">{{ $kesmavet->catatan_02 }}</td>
            </tr>
        </table>
        ...
        <table class="table-no-border">
            <tr>
                <td colspan="5"></td>
                <td style="text-align: center">Semarang, {!! tanggal($kesmavet->time_02) !!}</td>
            </tr>
            <tr>
