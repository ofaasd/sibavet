    ...
    <body>
        <table class="header">
            <tr>
                ...
                <td width="15%">
                    ...
                    <p style="height:20px;border:1px solid #000;font-size:10px;padding-top:5px;padding-left:5px;"><b>No. Epid : {{ $kesmavet->no_epid }}</b></p>
                </td>
            </tr>
        </table>
        ...
        <table class="table-no-border" cellpadding="3">
            <tr>
                ...
                <td width="3%"><b>:</b></td>
                <td colspan="3">{{ @$kesmavet->subSatuanKerja->sub_satuan_kerja }}</td>
            </tr>
            <tr>
                <td width="30%"><b>NO. CONTOH</b></td>
                <td width="3%"><b>:</b></td>
                <td colspan="3" style="">{{ @$kesmavet->no_epid }}</td>
            </tr>
            <tr>
                <td width="30%"><b>LABORATORIUM PENGUJI</b></td>
                <td width="3%"><b>:</b></td>
                <td colspan="3" style="">{{ @$kesmavet->seksiLaboratorium->seksi_laboratorium }}</td>
            </tr>
            <tr>
                <td width="30%"><b>PENGUJI YANG DITUNJUK</b></td>
                <td width="3%"><b>:</b></td>
                <td colspan="3" style="">{{ $kesmavet->penguji_ditunjuk }}</td>
            </tr>
            <tr>
                <td width="30%"><b>TANGGAL DITERIMA CONTOH</b></td>
                <td width="3%"><b>:</b></td>
                <td colspan="3" style="">{{ $kesmavet->tanggal_penerimaan }}</td>
            </tr>
        </table>
        <table class="table-border">
            <tr>
                <th height="35px" style="text-align:center; font-size:14px;">NO</th>
                <th style="text-align:center; font-size:14px;">Jenis Pengujian</th>
                <th style="text-align:center; font-size:14px;">JUMLAH</th>
                <th style="text-align:center; font-size:14px;">K</th>
                <th style="text-align:center; font-size:14px;">B</th>
            </tr>
        ...
        <table>
            <tr>
                ...
                <td width="3%"><b>:</b></td>
                <td colspan="3">{{ $kesmavet->catatan_hasil }}</td>
            </tr>
        </table>
        ...
        <table class="table-no-border">
            <tr>
                <td colspan="5"></td>
                <td colspan="1" style="text-align:center; padding-right:30px;">Semarang, {!! tanggal(@$kesmavet->time_03) !!}</td>
            </tr>
            <tr>
                ...
                <td style="">
                    ...
                    <br /><br /><br /><br />
                    <center>{{  @$kesmavet->manajer_teknis }}</center>
                </td>
            </tr>
            <tr>
