    ...
    <body>
        ...
        <table class="table-border" style="border:1.5px solid #000000;">
            <tr>
                ...
                <td style="text-align:center; font-size: 16px; vertical-align:middle;"><b>FORM 04</b></td>
            </tr>
        </table>
        ...
        <table class="table-no-border" cellpadding="3">
            ...
            <tr>
                ...
                <td width="3%"><b>:</b></td>
                <td colspan="3" style="">{{  @$kesmavet->pengujiDitunjuk->name }}</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td width="3%"><b>:</b></td>
                <td colspan="3">{{ $kesmavet->catatan_04 }}</td>
            </tr>
        </table>
