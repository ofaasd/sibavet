    ...
    <body>
        ...
        <table class="table-no-border" cellpadding="3">
            <tr>
                ...
                <td width="3%"><b>:</b></td>
                <td colspan="2">{{ @$kesmavet->subSatuanKerja->sub_satuan_kerja }}</td>
            </tr>
            <tr>
                <td width="30%"><b>NAMA PENGIRIM</b></td>
                <td width="3%"><b>:</b></td>
                <td colspan="2">{{ @$kesmavet->customer->nama_pelanggan }}</td>
            </tr>
            <tr>
                <td width="30%"><b>ALAMAT</b></td>
                <td width="3%"><b>:</b></td>
                <td colspan="2">{{ @$kesmavet->customer->alamat }}</td>
            </tr>
            <tr>
                <td width="30%"><b>JENIS CONTOH</b></td>
                <td width="3%"><b>:</b></td>
                <td colspan="2">{{ @$kesmavet->spesies->nama_spesies }}</td>
            </tr>
        ...
        <table class="table-no-border">
            <tr>
                <td  style="vertical-align:middle;"><b>BAHWA KIRIMAN CONTOH SDR. TELAH KAMI TERIMA : {!! $kesmavet->kriteria_contoh=="MS"?"MEMENUHI SYARAT":"TIDAK MEMENUHI SYARAT" !!}</b></td>
            </tr>
        </table>
        ...
        <table class="table-no-border" style="padding-top:-20px;">
            ...
            <tr>
                ...
                <td width="3%"><b>:</b></td>
                @if($kesmavet->bahan == 'Mampu')
                    <td colspan="3"><b>1). Mampu* &nbsp;&nbsp;&nbsp;&nbsp; <s>2. Tidak Mampu*</s></b></td>
                @elseif($kesmavet->bahan == 'Tidak Mampu')
                <td colspan="3"><b><s>1). Mampu*</s> &nbsp;&nbsp;&nbsp;&nbsp; 2. Tidak Mampu*</b></td>
                @endif
            </tr>
            <tr>
                ...
                <td width="3%"><b>:</b></td>
                @if($kesmavet->personil == 'Mampu')
                    <td colspan="3"><b>1). Mampu* &nbsp;&nbsp;&nbsp;&nbsp; <s>2. Tidak Mampu*</s></b></td>
                @elseif($kesmavet->personil == 'Tidak Mampu')
                <td colspan="3"><b><s>1). Mampu*</s> &nbsp;&nbsp;&nbsp;&nbsp; 2. Tidak Mampu*</b></td>
                @endif
            </tr>
            <tr>
        ...
        <table class="table-no-border">
            <tr>
                <td colspan="5"></td>
                <td colspan="1" style="text-align:center; padding-right:30px;">Semarang, {!! tanggal(@$kesmavet->tanggal_penerimaan) !!}</td>
            </tr>
            <tr>
                ...
                <td style="">
                    ...
                    <br /><br /><br /><br />
                    <center>{{  @$kesmavet->pengirim }}</center>
                </td>
                <td width="15%">&nbsp;</td>
                <td style="">
                    <center><b>Penerima</b></center>
                    <br /><br /><br /><br />
                    <center>{{  @$kesmavet->penerima }}</center>
                </td>
            </tr>
            <tr>
