<section class="content-header">
    <h1>
        <a href="#" class="tombol-home"><i class="fa fa-angle-left" style="font-size: 20pt"></i>&nbsp;Lab-Kesmavet<a><small> FORM 04 - PERINTAH PENGUJIAN</small>
    </h1>
    <ol class="breadcrumb">
        ...
        <div class="col-12 col-lg-12">
            <div class="box box-default">
                <div class="box-header with-border">
                    <h4 class="box-title">FORM 04 - PERINTAH PENGUJIAN <b>{!! $kesmavet->no_epid !!}</b></h4>
                ...
                <div class="box-footer flexbox">                     
                    <div class="text-right flex-grow">
                        ...
                        <a href="{!! URL::to('/lab/kesmavet/'.$kesmavet->id.'/cetak04') !!}" id="tombol-cetak" target="_blank" class="btn btn-primary">Cetak</a>
...
<script>
    ...
    $('#tombol-formhasil').click(function(e){
        ...
        store(function(result) {
            if(result==1){
                gotoUrl('/lab/kesmavet/{!! $kesmavet->id !!}/formhasil');
            }
        });
    });
